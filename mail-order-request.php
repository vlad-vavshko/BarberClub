...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' оставил заявку на ' . $service . ' к барберу - ' . $barber . '. Дата: ' . $date . 'Время: ' . $time . '. Его телефон: ' . $phone;

    // Первый параметр - кому отправляем письмо, второй - тема письма, третий - содержание
    $success = mail("admin@barberclub.com", 'Запрос на услугу', $content);
